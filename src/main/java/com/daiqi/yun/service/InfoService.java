...
public interface InfoService {
    ...
    * @return: java.util.List<com.daiqi.yun.entity.ClassificationInfo>
    * @Author: Su.Qing
    * @Date: 2021/2/19
    */
    ...
    * @return: com.daiqi.yun.entity.ClassificationInfo
    * @Author: Su.Qing
    * @Date: 2021/2/19
    */
    ClassificationInfo getOneInfo(Long id);
    ...
    * @Date: 2021/2/19
    */
    boolean  addInfo(ClassificationInfo info);
